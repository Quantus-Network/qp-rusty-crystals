...
1. **GitHub private security advisory (preferred).**
   [Report a vulnerability](https://github.com/quantus-network/qp-rusty-crystals/security/advisories/new).
...
**In scope:** the ML-DSA-87 implementation in this repository — signature forgery, key recovery, secret-dependent timing or other side channels, or deviations from FIPS 204.
